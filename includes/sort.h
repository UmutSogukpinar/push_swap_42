...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/17 16:04:51 by usogukpi          #+#    #+#             */
/*   Updated: 2025/01/20 18:37:00 by usogukpi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				optimum_way_utils_one(t_sort *main, t_way *alternate,
						int index);
void				optimum_way_utils_two(t_sort *main, t_way *alternate,
						int index);
void				optimum_way_utils_zero(t_sort *main, t_way *alternate,
						int index);
...
void				opt_rsnd_utils_one(t_sort *main, t_way *alternate,
						int index);
void				opt_rsnd_utils_two(t_sort *main, t_way *alternate,
						int index);
void				opt_rsnd_utils_zero(t_sort *main, t_way *alternate,
						int index);
